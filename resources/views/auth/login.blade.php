...
<div class="login-box">
  <div class="login-logo">
    <a href="{{URL::to('/')}}/"><img src="{{asset('img/LogoSystemDoc.png')}}" style="heigth:80px;width:100px;"/></a>
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body">
    ...
    <form action="{{ route('login') }}" method="POST">
      ...
      <div class="form-group has-feedback">
        <label for="email" class="col-sm-4 col-form-label text-md">{{ __('E-Mail') }}</label>

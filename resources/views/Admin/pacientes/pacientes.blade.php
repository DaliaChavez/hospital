	...
	<div class="card">
		<div class="content">
			...
			<div class="row container-fluid">
				<a role="button" data-toggle="collapse" href="#collStore" class="btn btn-primary">Nuevo paciente</a>
			...
			<div class="list-group">
					...
					<a href="/paciente/@{{item.id_paciente}}/perfil" class="list-group-item" v-for="item in items">
						<div class="row">
							<div class="col-md-11">
...
<div class="col-md-12">
	<div class="collapse" id="collStore">
	  	<div class="card">
	   		<div class="header"><center><h4 class="title">Registrar a un paciente</h4></center></div>
		   	<div class="content">
		   		@include('forms.paciente')
		   	</div>
	  	</div>
	</div>
</div>
@endsection
@section('script')
<script src="{{asset('vue/medico_vue.js')}}"></script>
@endsection
